...
.form-switch .form-check-input:focus {
  background-image: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='-4 -4 8 8'%3e%3ccircle r='3' fill='%23FFDD3B'/%3e%3c/svg%3e");
}
...
.breadcrumb-simple .breadcrumb-item + .breadcrumb-item::before {
  content: "";
}
...
.custom-control.color-control .custom-control-label::before {
  ...
  bottom: -4px;
  border-radius: 50%;
  border: 2px solid #3fa0ff  !important;
...
.nk-sidebar-profile-dropdown.content-active {
  display: block;
  left: 100%;
  bottom: 0;
}
...
.nk-apps-sidebar .nk-sidebar-profile > a {
  margin-left: auto;
  margin-right: auto;
}
...
.nk-apps-sidebar .dropdown-menu .sub-text, .nk-apps-sidebar .dropdown-menu .overline-title, .nk-apps-sidebar .dropdown-menu .overline-title-alt {
  color: #8094ae;
}
...
.nk-apps-brand.has-dropdown .logo-link:after {
  position: absolute;
  bottom: 0;
  left: 50%;
  transform: translateX(-50%);
...
.nk-apps-brand:hover .nk-apps-dropdown {
  opacity: 1;
  transform: translateX(0);
  visibility: visible;
}
...
.nk-apps-dropdown-list li:not(:last-child) {
  border-bottom: 1px solid #e5e9f2;
}
.nk-apps-dropdown-item {
  display: flex;
  align-items: center;
  padding: 1.25rem 1.5rem;
}
.nk-apps-dropdown-icon {
  flex-shrink: 0;
  width: 36px;
}
.nk-apps-dropdown-icon + .nk-apps-dropdown-text {
  margin-left: 1rem;
}
...
@media (min-width: 992px) {
  ...
  .nk-apps-sidebar .nk-sidebar-content {
...
.nk-menu-md .nk-menu-sub .nk-menu-link {
  padding: 0.375rem 32px 0.375rem 1.75rem;
}
.nk-menu-md .nk-menu-sub .nk-menu-sub {
  border-left: 1px solid #e5e9f2;
  margin-left: 1.75rem;
}
.nk-menu-md .nk-menu-sub .nk-menu-sub .nk-menu-link {
  padding-left: 1rem;
}
...
.nk-apps-sidebar .nk-menu {
  padding-left: 0;
  padding-right: 0;
}
.nk-apps-sidebar .nk-menu-link {
  padding: 0.75rem 0.5rem;
  text-align: center;
}
.nk-apps-sidebar .nk-menu-icon {
  width: 100%;
}
.nk-apps-sidebar .nk-menu-text {
  display: none;
}

@media (min-width: 992px) {
  .apps-menu > li.nk-menu-item.active > .nk-menu-link:before {
    opacity: 1;
  }
}
.nk-footer {
...
@media (min-width: 992px) {
  .npc-apps .nk-header, .npc-apps .nk-footer, .npc-apps .nk-content {
    padding-left: 14px;
    padding-right: 14px;
  }
}
...
.nk-error-head {
  font-size: 160px;
  font-weight: 700;
  background: -webkit-linear-gradient(#3fa0ff , #2c3782);
...
.ui-shady .nk-msg-item.active, .ui-shady .nk-msg-item.current {
  background: rgba(245, 246, 250, 0.5);
  position: relative;
}
...
.ui-shady.npc-apps-messages .nk-msg-item.active, .ui-shady.npc-apps-messages .nk-msg-item.current {
  background: #f5f6fa;
}
.ui-shady.npc-apps-messages .nk-msg-item.active:after, .ui-shady.npc-apps-messages .nk-msg-item.current:after {
  width: 3px;
}
.ui-shady.npc-apps-messages .nk-msg-reply {
  box-shadow: inset 0 0 8px -5px rgba(16, 25, 36, 0.2);
}
.ui-shady.npc-apps-messages .nk-header {
  box-shadow: 0 0 4px -1px rgba(16, 25, 36, 0.2);
}
.ui-shady.npc-apps-inbox .nk-ibx-reply, .ui-shady.npc-apps-inbox .nk-ibx-nav {
  box-shadow: inset 0 0 8px -5px rgba(16, 25, 36, 0.2);
}
.ui-shady.npc-apps-inbox .nk-header {
  box-shadow: 0 0 4px -1px rgba(16, 25, 36, 0.2);
}
...
.ui-shady.npc-apps-files .nk-fmg-body-content {
  box-shadow: inset 0 0 8px -5px rgba(16, 25, 36, 0.2);
}
.ui-shady .nk-content {
  box-shadow: inset 0 0 8px -5px rgba(16, 25, 36, 0.2);
...
body.dark-mode.nk-body.ui-clean {
...
.dark-mode .table th, .dark-mode .table td, .dark-mode .table-bordered, .dark-mode .table-bordered th, .dark-mode .table-bordered td, .dark-mode .datatable-wrap, .dark-mode .nk-tb-head .nk-tb-col, .dark-mode .list-apps + .list-apps,
...
.dark-mode .tagify__tag > div::before, .dark-mode .tagify__tag:hover:not([readonly]) div::before {
  box-shadow: 0 0 0 1.1em #101114 inset;
}
...
.dark-mode .bs-popover-top > .popover-arrow::after, .dark-mode .bs-popover-auto[data-popper-placement^=top] > .popover-arrow::after {
  border-top-color: #1e222d !important;
}
...
.dark-mode .bs-popover-end > .popover-arrow::after, .dark-mode .bs-popover-auto[data-popper-placement^=right] > .popover-arrow::after {
  border-right-color: #1e222d !important;
}
...
.dark-mode .nk-apps-sidebar.is-light, .dark-mode .nk-apps-sidebar, .dark-mode .nk-apps-sidebar.is-dark, .dark-mode .nk-apps-sidebar.is-theme,
.dark-mode .is-light .nk-sidebar-footer, .dark-mode .nk-sidebar-profile-fixed,
.dark-mode .nk-sidebar, .dark-mode .nk-sidebar.is-light, .dark-mode .nk-sidebar-head {
  border-color: #203247 !important;
}
.dark-mode .nk-apps-sidebar.is-light, .dark-mode .nk-apps-sidebar, .dark-mode .nk-apps-sidebar.is-dark, .dark-mode .nk-apps-sidebar.is-theme,
.dark-mode .is-theme .nk-sidebar-footer, .dark-mode .is-light .nk-sidebar-footer, .dark-mode .nk-sidebar-footer, .dark-mode .nk-sidebar-profile-fixed {
  background: #101114;
}
.dark-mode .nk-sidebar, .dark-mode .nk-sidebar.is-light, .dark-mode .nk-header.is-theme:not([class*=bg-]), .dark-mode .nk-header,
.dark-mode .nk-header.is-light:not([class*=bg-]), .dark-mode .nk-header.is-dark:not([class*=bg-]) {
  background: #1F2025;
}
...
.dark-mode .fc-timegrid-event-harness-inset .fc-timegrid-event, .dark-mode .fc-timegrid-event.fc-event-mirror {
  box-shadow: 0px 0px 0px 1px #101114;
}
...
.dark-mode.ui-shady.npc-apps-messages .nk-msg-item.active, .dark-mode.ui-shady.npc-apps-messages .nk-msg-item.current, .dark-mode.ui-clean.npc-apps-messages .nk-msg-item.active, .dark-mode.ui-clean.npc-apps-messages .nk-msg-item.current {
  background-color: #1b2633;
}
.dark-mode.ui-clean.npc-apps-messages .nk-msg-aside, .dark-mode.ui-clean.npc-apps-messages .nk-msg-nav {
  background-color: #101114;
}
