...
!function (NioApp, $) {
  ...
  var salesRevenue = {
    ...
    datasets: [{
      label: "Sales Revenue",
      color: [NioApp.hexRGB("#cea31a", .2), NioApp.hexRGB("#cea31a", .2), NioApp.hexRGB("#cea31a", .2), NioApp.hexRGB("#cea31a", .2), NioApp.hexRGB("#cea31a", .2), NioApp.hexRGB("#cea31a", .2), NioApp.hexRGB("#cea31a", .2), NioApp.hexRGB("#cea31a", .2), NioApp.hexRGB("#cea31a", .2), NioApp.hexRGB("#cea31a", .2), NioApp.hexRGB("#cea31a", .2), "#cea31a"],
  ...
  var activeSubscription = {
    ...
    datasets: [{
      label: "Active User",
      color: [NioApp.hexRGB("#cea31a", .2), NioApp.hexRGB("#cea31a", .2), NioApp.hexRGB("#cea31a", .2), NioApp.hexRGB("#cea31a", .2), NioApp.hexRGB("#cea31a", .2), "#cea31a"],
